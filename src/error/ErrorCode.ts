...
enum ErrorCode {
   ...
   */
  DATABASE_TABLE_NOT_FOUND = "GE_305",

  /**
   * Pool not found
   * @description Check the connection config on create pool
   */
  DATABASE_POOL_UNDEFINED = "GE_306",
...
const ErrorMessage: { [key in ErrorCode]: string } = {
  ...
  [ErrorCode.DATABASE_TABLE_NOT_FOUND]: "Table is not found !",
  [ErrorCode.DATABASE_POOL_UNDEFINED]: "Pool is undefined",
  ...
  [ErrorCode.COMMAND_OPTION_UNDEFINED_OR_INVALID]:
    "The command option is not defined or is invalid",
